...
import { JettonMinter, jettonMinterConfigCellToConfig, parseJettonMinterData } from './JettonMinter';
...
export const checkJettonMinter = async (
    ...
    console.assert(
        equalsMsgAddresses(getNextAdminAddress, parsedData.transfer_admin),
        "Next admin address doesn't match",
    );
