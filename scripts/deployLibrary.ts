import { Librarian } from '../wrappers/mintless/Librarian';
...
export async function run(provider: NetworkProvider) {
    ...
    ui.write(
        'This jetton contract uses the jetton-wallet code from library. This reduces network fees when operating with the jetton.'
    );
    ui.write('Librarian is the contract that stores the library.');
    ui.write(
        "If someone is already storing this jetton-wallet library on the blockchain - you don't need to deploy librarian."
    );
